                            ...
                            <div class="row profil">
                                ...
                                <div class="col-12 d-flex flex-row align-items-center justify-content-around">
                                    <?php if (!empty($userInfo["company"])): ?>
                                        <p class="fs-5"><svg class="octicon octicon-organization" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                                    ...
                                    <?php if (!empty($userInfo["blog"])): ?>
                                        <p class="fs-5"><svg title="Social account" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-link">
                                    ...
                                    <?php if (!empty($userInfo["location"])): ?>
                                        <p class="fs-5"><svg class="octicon octicon-location" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                                                <path d="m12.596 11.596-3.535 3.536a1.5 1.5 0 0 1-2.122 0l-3.535-3.536a6.5 6.5 0 1 1 9.192-9.193 6.5 6.5 0 0 1 0 9.193Zm-1.06-8.132v-.001a5 5 0 1 0-7.072 7.072L8 14.07l3.536-3.534a5 5 0 0 0 0-7.072ZM8 9a2 2 0 1 1-.001-3.999A2 2 0 0 1 8 9Z"></path>
                                            </svg> <?php echo $userInfo['location']; ?></p>
                                    <?php endif; ?>
                                    <?php if (!empty($userInfo["email"])): ?>
                                        <p class="fs-5"><svg class="octicon octicon-mail" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                                ...
                                <div class="col-12 d-flex flex-row align-items-center justify-content-around mt-1">
                                    <a target="_blank" href="<?php echo $userInfo['repos_url']; ?>">
                                        <p class="fs-4"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo UnderlineNav-octicon">
                                    ...
                                    <a target="_blank" href="<?php echo $userInfo['followers_url']; ?>">
                                        <p class="fs-4"><svg text="muted" aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-people">
                                                        ...
                                                        <div class="row d-flex align-items-center">
                                                            <div class="col-10">
                                                                <a target="_blank" href="<?php echo $issue['html_url']; ?>">
                                                                    <p class="fs-6 text-start text-truncate"><svg aria-hidden="true" focusable="false" class="octicon octicon-git-branch" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" display="inline-block" overflow="visible" style="vertical-align:text-bottom">
                                                                            <path d="M9.5 3.25a2.25 2.25 0 1 1 3 2.122V6A2.5 2.5 0 0 1 10 8.5H6a1 1 0 0 0-1 1v1.128a2.251 2.251 0 1 1-1.5 0V5.372a2.25 2.25 0 1 1 1.5 0v1.836A2.493 2.493 0 0 1 6 7h4a1 1 0 0 0 1-1v-.628A2.25 2.25 0 0 1 9.5 3.25Zm-6 0a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Zm8.25-.75a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5ZM4.25 12a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Z"></path>
                                                                        </svg> <?php echo $issue['title']; ?></p>
                                                                </a>
                                                            </div>
                                                            <div class="col-2 ">
